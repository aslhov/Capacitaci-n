 ...
 * @author wason
 */
public class CapacitacionView extends RecursiveTreeObject {
    ...
    public CapacitacionView(long id, String acciones, String mes_inicio, int anyo_inicio, String mes_fin, int anyo_fin, String tipo_Accion, String trimestre, String lugar, String modo_formacion, String responsable, boolean cumplimiento) {
        this.id = id;

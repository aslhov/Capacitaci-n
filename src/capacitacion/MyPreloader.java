...
//          if (info instanceof ProgressNotification) {
 //          splashScreeenController.label.setText("Cargando "+((ProgressNotification) info).getProgress()*100 + "%");
//          //  System.out.println("Value@ :" + ((ProgressNotification) info).getProgress());
//            splashScreeenController.statProgressBar.setProgress(((ProgressNotification) info).getProgress());
       // }
